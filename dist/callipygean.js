/*jshint nomen:false, browser: true, regexp:false */
/*global exports*/
    ...
    var _ = {
        ...
        forOwn: function (obj, fn, ctx, async) {
            ...
            for (k in obj) {
                if (obj.hasOwnProperty(k)) {
                    if (async) {
                        setTimeout(this.bind(fn, context, k, obj[k], obj), 0);
                    } else {
                        fn.call(context, k, obj[k], obj);
                    }
                }
            }
        ...
        convert: function (obj, cb) {
            ...
            _.forOwn(obj, function (key, val) {
                ...
                if (_.is.object(val)) {
                    ...
                    child.appendChild(this.buildStandard(val));
                }
        ...
        buildArray: function (arr) {
            ...
            _.forEach(arr, function (val) {
                ...
                if (_.is.object(val)) {
                    ...
                    li = this.buildArray(val);
                } else {
                    li = this.buildStandard(val, 'li');
                }
